// importacao dos modulos externos necessários no projeto
const inquirer = require('inquirer')
const chalk = require('chalk')

// importacao dos core modulos
const fs = require('fs')
...
function addAmount(accountName, amount){
    ...
    accountData.balace = parseFloat(amount) + parseFloat(accountData.balace)
...
function getAccountBalace(){
    ...
    inquirer.prompt([
        ...
        console.log(chalk.bgBlue.black(`Olá, o saldo da sua conta é de R$${accountData.balace}`))
